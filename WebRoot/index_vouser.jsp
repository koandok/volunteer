...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="images/logo.jpg" class="radius-circle rotate-hover" height="50" alt="" />志愿者管理系统-青协</h1>
...
<li> <h2><a href="<%=path %>/ArtServlet?action=list" target="right"><span class="icon-user"></span>班级管理</a></h2></li>
...
<ul class="bread">
  <li><a href="index_inst.jsp"  class="icon-home"> 首页</a></li>
  <li><a href="index_inst.jsp" id="a_leader_txt">欢迎界面</a></li>
