...
<body>
<%
Building build = (Building)request.getAttribute("build");
    ...
    <form method="post" class="form-x" action="<%=path%>/BuildServlet?action=edit">  
      <div class="form-group">
        ...
        <div class="field" align="center">
          <input  type="text" class="input w50" value="<%=build.getBuildID()%>" name="buildID" readonly="ture" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field" align="center">
          <input type="text" class="input w50" value="<%=build.getBuildName()%>" name="buildName" data-validate="required:请输入班号" />
          <div class="tips"></div>
        </div>
      </div>
